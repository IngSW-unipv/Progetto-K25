...
public class AbbonamentoSettimanale extends Abbonamento {
    public AbbonamentoSettimanale(String id, String idPagamento, LocalDate emissione, double prezzo, String tipoAbbonamento, LocalDate scadenza, String idTessera) {
        super(id, idPagamento, emissione, prezzo, tipoAbbonamento, scadenza, idTessera);
    }

    @Override
    public void setScadenzaAbbonamento(){
        this.setScadenza( LocalDate.now().plusWeeks(1));
    }
